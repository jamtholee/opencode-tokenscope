...
const BUNDLED_ASSET_PATH_CACHE = new Map();
export async function resolveBundledAssetPath(filename, moduleDir = MODULE_DIR) {
...
async function readTokenscopeConfigFile(configPath) {
    try {
...
export const HUGGINGFACE_TOKENIZER_MODEL_MAP = {
